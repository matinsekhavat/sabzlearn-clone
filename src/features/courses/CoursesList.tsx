  ...
  return (
    <div className="container">
      ...
      <div className="rounded-3xl bg-white overflow-hidden">
        ...
        {/* downside */}
        <div className="p-2">
          <h3 className="text-slate-950 text-lg line-clamp-2 font-semibold">
          ...
          {/* teacher & rate */}
          <div className="flex items-center justify-between border-b border-slate-300 pb-4 font-medium">
